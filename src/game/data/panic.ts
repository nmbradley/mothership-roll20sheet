export type PanicEffect = {
  ...
  name: string;
  effect: string;
  /** Whether the result leaves a lasting Condition behind (21.3). */
  condition: boolean;
};
...
export const panicTable: PanicEffect[] = [
  ...
  },
  {
    roll: 5,
    name: "COWARD",
    effect: "Gain a new Condition: You must make a Fear Save to engage in violence, "
      + "otherwise you flee.",
    condition: true,
  },
  {
    roll: 6,
    name: "FRIGHTENED",
    effect: "Gain a new Condition: When encountering what frightened you, make a Fear Save [-] "
      + "or gain 1d5 Stress.",
    condition: true,
  },
  {
  ...
  },
  {
    roll: 10,
    name: "DOOMED",
    effect: "Gain a new Condition: You feel cursed and unlucky. All Critical Successes are "
      + "instead Critical Failures.",
    condition: true,
  },
  {
    roll: 11,
    name: "SUSPICIOUS",
    effect: "For the next week, whenever someone joins the crew (even if they only left for a "
      + "short period of time), make a Fear Save or gain 1 Stress.",
    condition: false,
  },
  {
    roll: 12,
    name: "HAUNTED",
    effect: "Gain a new Condition: Something starts visiting the character at night. In their "
      + "dreams. Out of the corner of their eye. And soon it will start making demands.",
    condition: true,
  },
  {
    roll: 13,
    name: "DEATH WISH",
    effect: "For the next 24 hours, whenever encountering a stranger or known enemy, make a "
  ...
  },
  {
    ...
    effect: "Character immediately experiences an intense hallucination or vision of an "
      + "impending terror or horrific event. Increase Minimum Stress by 2.",
    condition: false,
  },
  {
    roll: 15,
  ...
  },
  {
    ...
    effect: "Reduce Maximum Wounds by 1. Gain [-] on all rolls for 1d10 hours. Increase "
      + "Minimum Stress by 1.",
    condition: false,
  },
  {
